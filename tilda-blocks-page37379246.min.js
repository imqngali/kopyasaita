...
return styleStr}
function t778_copyTypography(recid){var rec=document.getElementById('rec'+recid);if(!rec)return;var title=rec.querySelector('.t778__title');var description=rec.querySelector('.t778__descr');if(title)var titleStyle=title.getAttribute('style');if(description)var descriptionStyle=description.getAttribute('style');if(!titleStyle||!descriptionStyle)return;var popupTitles=rec.querySelectorAll('.t-popup .t778__title');Array.prototype.forEach.call(popupTitles,function(title){title.setAttribute('style',t778_removeSizeStyles(titleStyle?titleStyle:''))});var popupDescription=rec.querySelectorAll('.t-popup .t778__descr, .t-popup .t778__text');Array.prototype.forEach.call(popupDescription,function(description){description.setAttribute('style',t778_removeSizeStyles(descriptionStyle?descriptionStyle:''))})}
